...
WaveSurfer.Region = {
    ...
    bindEvents: function () {
        ...
        this.element.addEventListener('mouseenter', function (e) { //只有在鼠标指针穿过被选元素时触发
            my.fireEvent('mouseenter', e);
            my.wavesurfer.fireEvent('region-mouseenter', my, e);
        });

        this.element.addEventListener('mouseleave', function (e) {//鼠标指针离开被选元素时触发
        ...
        (this.drag || this.resize) && (function () {
            ...
            my.element.addEventListener('mousedown', onDown); //监听
            my.wrapper.addEventListener('mousemove', onMove);
            document.body.addEventListener('mouseup', onUp);

            my.on('remove', function () {
                document.body.removeEventListener('mouseup', onUp); //移除监听
